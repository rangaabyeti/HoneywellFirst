...
namespace xCodedUI.AppControls.WebControls
{
    ...
    /// </summary>
    public class xHtmlDiv : HtmlDiv, IxControl
    {
        public xHtmlDiv(UITestControl parent) : base(parent) { }

        public xHtmlDiv(UITestControl parent, string id, string searchProperty = "Id")
            : base(parent)
        {
